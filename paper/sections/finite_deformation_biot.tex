...
preserves elastic shape, as can be checked directly:
\begin{align}
...
Equation \eqref{eq:drained-energy-cauchy-work} uses the Cauchy-stress transformation
...
derivative \eqref{eq:single-prime-fixed-density-conjugate} and the density
conjugacy \eqref{eq:intrinsic-pressure-free-energy}.  In
...
\end{equation}
Condition \eqref{eq:trace-mineral-stability-domain} keeps the scalar derivative positive.  We also require
...
\(J^e=J/a^p\) in \eqref{eq:verification-mineral-factors}, while the denominator
of \eqref{eq:poroplastic-biot-correction}
...
mineral equation \eqref{eq:verification-mineral-factors} and coefficient

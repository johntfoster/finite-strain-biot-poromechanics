...
\\
 &=\frac13\tr\bs\sigma^{\prime\prime}_d-\alpha p.
...
retains the current plastic deformation, and \(\alpha\) is evaluated using
...
\begin{align*}
 ...
 &=\alpha+p\left.\pder{\alpha}{p}\right|_{\mbf F,\mbf F^p},

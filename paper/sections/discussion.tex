...
The calibrated constitutive-path study supports two conclusions. First, a decreasing Biot
...
Second, agreement with Figure~3c does not independently validate the selected
...
direct experiment: measure the intrinsic solid specific-volume change as the
skeleton volume changes while pore pressure is held fixed. A pressure-controlled
numerical experiment must likewise solve displacement and pressure from its
boundary conditions instead of prescribing the fitted \(J_s(P)\) path.

...
\eqref{eq:barotropic-water-density}.  The small load keeps the Biot coefficient
...
tests the elastic model at finite deformation, and plastic history is
examined separately in the material-point calculations of

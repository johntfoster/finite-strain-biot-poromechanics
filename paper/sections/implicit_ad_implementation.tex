...
\eqref{eq:trace-mineral-stability-domain}.  A sign-changing interval is
constructed within the region where the scalar residual has positive slope,
and bisection determines the mineral solution.  Newton updates evaluated
...
local consistency Jacobian.  Both \(\mbf F^p_n\) and \(\gamma_n\) remain
...
The resulting mass-balance drift is assessed by time-step refinement in
Sec.~\ref{sec:mandel-verification}.
